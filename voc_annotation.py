...
if __name__ == "__main__":
    ...
    segfilepath     = os.path.join(VOCdevkit_path, r'C:\Users\amax\Desktop\DIGIX\Gang\Unet\unet-pytorch-main\test1')
    saveBasePath    = os.path.join(VOCdevkit_path, r'C:\Users\amax\Desktop\DIGIX\Gang\Unet\unet-pytorch-main\VOC')
