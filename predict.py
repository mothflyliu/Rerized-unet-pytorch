...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval = 100
    fps_image_path  = r"C:\Users\amax\Desktop\DIGIX\Gang\Unet\unet-pytorch-main\test\test\000001.jpg"
    #-------------------------------------------------------------------------#
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "img/"
    dir_save_path   = r"C:\Users\amax\Desktop\DIGIX\Gang\Unet\unet-pytorch-main\img\test1"
    #-------------------------------------------------------------------------#
